  ...
  return (
    ...
    <div className="flex flex-col items-center gap-4 md:gap-6">
      ...
      <h1 className="max-w-2xl text-center text-3xl font-medium md:text-5xl">
        Welcome to our <span className='text-ai'>innovative</span> training platform
      </h1>
    </div>
    <div className="mt-16 flex flex-col justify-between gap-6 md:flex-row lg:mt-20 lg:gap-10">
      <div className="rounded-lg border  bg-card text-card-foreground shadow-sm group p-6">
        ...
        <div className="mt-10 flex items-center justify-between">
          ...
          <p className="text-sm font-light lg:text-base">Built with</p>
          <img src="/word-1.svg" alt="shadcn" className="h-5" />
        </div>
      </div>
      <div className="rounded-lg border  bg-card text-card-foreground shadow-sm group p-6">
        <a href="#"
        ...
        <div className="mt-10 flex items-center justify-between">
          ...
          <img src="/word-2.svg" alt="shadcn" className="h-4" />
        </div>
      </div>
    </div>
</section>
