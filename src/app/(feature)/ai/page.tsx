      ...
      <section className="py-24">
        <div>
          <div className="flex w-full flex-col items-center">
            <div className="flex flex-col items-center space-y-4 text-center sm:space-y-6 md:max-w-3xl md:text-center">
              ...
              <p className="text-zinc-600 md:max-w-2xl">
                We combine advanced AI tools with expert knowledge to deliver an exceptional Chinese
                learning experience. With interactive lessons, personalized learning, and real-time
                feedback, mastering Chinese has never been easier.
              </p>
            </div>
          ...
          <div className="mx-auto mt-20 grid max-w-5xl gap-6 md:grid-cols-2">
            <a
              href="/story"
              className="flex flex-col justify-between rounded-lg bg-foreground/10 hover:scale-95 hover:shadow-2xl hover:shadow-foreground/10 transition p-6 md:min-h-[300px] md:p-8"
            >
              ...
              <div>
                ...
                <p className="mt-2 text-zinc-600">
                  Explore stories in Chinese, specially curated to enhance your reading and
            ...
            >
              ...
              <div>
                <h3 className="text-lg font-medium md:text-2xl">Chat</h3>
                <p className="mt-2 text-zinc-600">
                  Practice your spoken Chinese by engaging in live conversations with native speakers
                  or AI tutors.
                </p>
              </div>
            </a>
            ...
            >
              ...
              <div>
                ...
                <p className="mt-2 text-zinc-600">
                  Engage in stories with conversational practice to improve both listening and
                  speaking.
                </p>
              </div>
            </a>
            ...
            >
              ...
              <div>
                <h3 className="text-lg font-medium md:text-2xl">Groq Chat</h3>
                <p className="mt-2 text-zinc-600">
                  Interact with our AI-powered Groq chat to simulate real-world conversations and
      ...
      <section className="py-32 max-w-5xl mx-auto">
        <div className="container">
          ...
          <div className="mt-14 grid gap-6 lg:mt-20 lg:grid-cols-3">
            <a
              href="/dictionary"
              className="rounded-lg bg-foreground/10 hover:scale-95 hover:shadow-2xl hover:shadow-foreground/10 transition p-5"
            >
              ...
              <p className="leading-7 text-zinc-600">
                Our extensive dictionary provides clear definitions, example sentences, and audio
            ...
            >
              ...
              <p className="leading-7 text-zinc-600">
                Translate between Chinese and multiple languages quickly and accurately with our
            ...
            >
              ...
              <p className="leading-7 text-zinc-600">
                Our AI-powered tools push the boundaries of language learning, providing you with
