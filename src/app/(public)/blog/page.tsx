        ...
        <div className="mb-12 flex cursor-pointer flex-col overflow-hidden">
          <a href="/blog-post">
            <div className="shrink-0">
              <img className="h-48 w-full rounded-lg object-cover" src="/topic-1.svg" alt="" />
            </div>
          </a>
            ...
            <div className="flex-1">
              ...
              <a href="#" className="mt-2 block space-y-6">
                ...
                <div className="mt-6 flex items-center">
                  <div>
                    <img className="inline-block size-9 rounded-full" src="/images/placeholders/original/avatar-bw-1.webp" alt="" />
                  </div>
                  <div className="ml-3">
            ...
            <div className="flex flex-1 flex-col justify-between">
              ...
              <div className="flex-1">
                ...
                <a href="#" className="mt-2 block space-y-6">
                  ...
                  <div className="mt-6 flex items-center">
                    <div>
                      <img className="inline-block size-9 rounded-full" src="/images/placeholders/original/avatar-bw-2.webp"
                        alt="" />
                    </div>
                    <div className="ml-3">
                      <p className="text-sm font-medium text-gray-700 group-hover:text-gray-600">
            ...
            <div className="flex flex-1 flex-col justify-between">
              ...
              <div className="flex-1">
                ...
                <a href="#" className="mt-2 block space-y-6">
                  ...
                  <div className="mt-6 flex items-center">
                    <div>
                      <img className="inline-block size-9 rounded-full" src="/images/placeholders/original/avatar-bw-3.webp"
                        alt="" />
                    </div>
                    <div className="ml-3">
                      <p className="text-sm font-medium text-gray-700 group-hover:text-gray-600">
