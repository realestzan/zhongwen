...
export default function Page() {
  ...
  <div>
    ...
    <div className="mx-auto mt-20 grid max-w-5xl gap-6 md:grid-cols-2">
      <div className="flex flex-col justify-between rounded-lg bg-foreground/10 p-6 md:min-h-[300px] md:p-8">
        ...
        <div>
          <h3 className="text-lg font-medium md:text-2xl">Quality</h3>
      ...
      <div className="flex flex-col justify-between rounded-lg bg-foreground/10 p-6 md:min-h-[300px] md:p-8">
        ...
        <div>
          <h3 className="text-lg font-medium md:text-2xl">Innovation</h3>
          <p className="mt-2 text-zinc-600">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quasi necessitatibus, culpa at
            vitae molestias tenetur explicabo.
          </p>
      ...
      <div className="flex flex-col justify-between rounded-lg bg-foreground/10 p-6 md:min-h-[300px] md:p-8">
        ...
        <div>
          <h3 className="text-lg font-medium md:text-2xl">Customer Support</h3>
          <p className="mt-2 text-zinc-600">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quasi necessitatibus, culpa at
            vitae molestias tenetur explicabo.
          </p>
      ...
      <div className="flex flex-col justify-between rounded-lg bg-foreground/10 p-6 md:min-h-[300px] md:p-8">
        ...
        <div>
          <h3 className="text-lg font-medium md:text-2xl">Reliability</h3>
          <p className="mt-2 text-zinc-600">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quasi necessitatibus, culpa at
            vitae molestias tenetur explicabo.
          </p>
