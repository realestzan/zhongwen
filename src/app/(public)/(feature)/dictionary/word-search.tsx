            ...
            <div className="items-start text-left lg:inline-flex">
              <div className="lg:pr-16">
                <h1
                  ...
                  Search any Character <div className='w-full text-ai text-7xl font-black'>汉字</div>
                </h1>
              </div>
              <div>
                ...
                <div>
                  <form action="" method="post" id="revue-form" name="revue-form"
                    ...
                    <div className="mt-4 sm:ml-3 sm:mt-0">
                      <button value="Subscribe" name="member[subscribe]" id="member_submit"
                        className="block w-full rounded-xl border  border-transparent bg-black px-5 py-3 text-base font-medium text-white shadow hover:bg-black/70 transition focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-300 sm:px-10"><a href='/dictionary/entry'>Test Demo</a></button>
                    </div>
                  </form>
