...
//                           <p className="text-base   dark:text-gray-400">Graphic Designer, educator & CEO Flowbite</p>
//                           <p className="text-base   dark:text-gray-400"><time dateTime="2022-02-08" title="February 8th, 2022">Feb. 8, 2022</time></p>
//                       </div>
//                   </div>
//               </address>
...
//   &lt;dd className="text-lg font-normal   dark:text-gray-400"&gt;developers&lt;/dd&gt;
// &lt;/div&gt;
// &lt;div className="flex flex-col justify-center items-center"&gt;
//   &lt;dt className="mb-2 text-3xl font-extrabold"&gt;1B+&lt;/dt&gt;
//   &lt;dd className="text-lg font-normal   dark:text-gray-400"&gt;contributors&lt;/dd&gt;
// &lt;/div&gt;
// &lt;div className="flex flex-col justify-center items-center"&gt;
//   &lt;dt className="mb-2 text-3xl font-extrabold"&gt;4M+&lt;/dt&gt;
//   &lt;dd className="text-lg font-normal   dark:text-gray-400"&gt;organizations&lt;/dd&gt;
// &lt;/div&gt;
// &lt;/dl&gt;
// </code></pre>
//           <h4>Table example</h4>
...
//                           className="inline-flex items-center p-2 text-sm font-medium text-center   bg-white rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-50 dark:text-gray-400 dark:bg-gray-900 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
//                           type="button">
...
//                       <button type="button"
//                           className="flex items-center font-medium text-sm   hover:underline dark:text-gray-400">
...
//               </h2>
//               <p className="mb-4   dark:text-gray-400">Over the past year, Volosoft has undergone many changes! After months of preparation.</p>
...
//           <p className="mx-auto mb-8 max-w-2xl    md:mb-12 sm:text-xl dark:text-gray-400">Stay up to date with the roadmap progress, announcements and exclusive discounts feel free to sign up with your email.</p>
//           <form action="#">
//               <div className="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
//                   <div className="relative w-full">
//                       <label htmlFor="email" className="hidden mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Email address</label>
//                       <div className="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
//                           <svg className="w-4 h-4   dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 16">
...
//                   </div>
//               </div>
//               <div className="mx-auto max-w-screen-sm text-sm text-left   newsletter-form-footer dark:text-gray-300">We care about the protection of your data. <a href="#" className="font-medium text-primary-600 dark:text-primary-500 hover:underline">Read our Privacy Policy</a>.</div>
//           </form>
//       </div>
//   </div>
// </section>
...
//               Flowbite    
//           </a>
//           <span className="block text-sm text-center   dark:text-gray-400">© 2021-2022 <a href="#" className="hover:underline">Flowbite™</a>. All Rights Reserved.
//           </span>
