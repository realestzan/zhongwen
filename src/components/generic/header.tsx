...
const other = [
  ...
  { name: 'Pricing', description: 'Get a better understanding of your traffic', href: '#', icon: ChartPieIcon },
]
const otherActions = [
  { name: 'Sign in', href: '#', icon: PlayCircleIcon },
  { name: 'Sign up', href: '#', icon: PhoneIcon },
]
